...
class SimpleGoBoard(object):
    ...
    def legal_moves_gomoku(self):
        white = where1d(self.board == WHITE)
        black = where1d(self.board == BLACK)
        n = np.append(white, black)
...
#            return
    ...
    def get_pattern_moves(self):
        ...
        #moveSet=[set(),set(),set(),set(),set(),set(),set(),set(),set(),set(),set()]
        moveSet = [[],[],[],[],[],[],[],[],[],[],[],[]]
        ...
        patternList=[{'xxxx.':{0},'xxx.x':{1},'xx.xx':{2},'x.xxx':{3},'.xxxx':{4}}, 
                     ...
                     {'Bxxx..':{0,1}, 'oxxx..':{0,1}, '..xxxB':{4,5}, '..xxxo':{4,5}, 'Bxx.x.':{0,2}, '.xx.xB':{2,5}, 'oxx.x.':{0,2}, '.xx.xo':{2,5},'ox.xx.':{0,3}, '.x.xxo':{3,5}, 'Bx.xx.':{0,3}, '.x.xxB':{3,5},'.xxx.':{0,4}},
                     {'Booo..':{0,1}, 'xooo..':{0,1}, '..oooB':{4,5}, '..ooox':{4,5}, 'Boo.o.':{0,2}, '.oo.oB':{2,5}, 'xoo.o.':{0,2}, '.oo.ox':{2,5}, 'xo.oo.':{0,3}, '.o.oox':{3,5}, 'Bo.oo.':{0,3}, '.o.ooB':{3,5}, '.ooo.':{0,4}}, 
                     {'..xx...':{2}, '...xx..':{4}}, 
                     {'o.xx...':{2},'B.xx...':{2}, '...xx.o':{4}, '...xx.B':{4}, 'o.x.x..':{3}, 'B.x.x..':{3}, '..x.x.o':{3}, '..x.x.B':{3}}, 
                     {'..oo.':{0,3}, '.oo..':{1,4}, '.o.o.':{0,2,4}, '..oo.x':{5}, 'x.oo..': {0}, '..oo.B':{5}, 'B.oo..': {0}}, 
                     {'.x...':{1,2}, '..x..':{1,3}, '...x.':{2,3}}, 
                     {'oxx...':{1,2}, 'Bxx...':{1,2}, '...xxo':{3,4}, '...xxB':{3,4}, 'o.xx..o':{2}, 'o..xx.o':{4}, 'o.x.x.o':{3}}, 
                     ]
        '''

        patternList=[{'xxxx.':{0},'xxx.x':{1},'xx.xx':{2},'x.xxx':{3},'.xxxx':{4}}, #win
                     {'oooo.':{0},'ooo.o':{1},'oo.oo':{2},'o.ooo':{3},'.oooo':{4}}, #block win
                     {'.xxx..':{1},'..xxx.':{4},'.xx.x.':{2},'.x.xx.':{3},'.x.x.x.':{2,4}}, #make-four
                     {'.ooo..':{1,5},'..ooo.':{0,4},'.oo.o.':{0,2,5},'.o.oo.':{0,3,5}, 'B.ooo..':{0}, '..ooo.B':{6},
                     'x.ooo..':{0}, '..ooo.x':{6},'.o.o.o.':{0,2,4}}, #block-open-four
                     {'..xxx':{3}, 'xxx..':{1}, 'xx.x.':{2}, '.x.xx':{2}, 'x.xx.': {3}, '.xx.x':{1}, 'x.x.x':{1,3}}, #dead four
                     {'...oo..':{1,4}, '..oo...':{2,5}, '..o.o..':{3}, '...o.o.':{2},'.o.o...':{4}, '..o..o.':{2,3}, '.o..o..':{3,4}}, #block-double-three
                     {'..xx..':{1,4},'B.xx...':{1,2},'...xx.B':{4,5},'..x.x..':{1,3,5},'B.x.x..':{1,3},'..x.x.B':{3,5}},
                     {'o..oo.o':{4}, 'o.oo..o':{2}},
                     {'.x..x.':{2,3},'o.xx...':{1,2},'...xx.o':{4,5},'o.x.x..':{1,3},'..x.x.o':{3,5}}, #make-three
                     {'.x.....':{4}, '..x....':{3,5},'...x...':{2,4},'....x..':{1,3},'.....x.':{2},
                     '.x....o':{4},'..x...o':{3},'o..x...':{2},'...x..o':{4},'o....x.':{2},'o...x..':{3}}, #make-two1
                     {'o..x..':{1,3},'B..x..':{1,3},'o.x...':{2},'B.x...':{2},'..x..o':{2,4},'..x..B':{2,4},'...x.o':{3},'...x.B':{3}} #make-two2
                    ]
        ...
        i=0
        while i<10 and not bool(moveSet[i]): i+=1
        if i==10:
            return None
        else:
