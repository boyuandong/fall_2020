...
#            return False
    ...
    def check_game_over(self):
        ...
        for point in range (self.maxpoint):
            ...
            if self.get_color(point) == BLACK or self.get_color(point) == WHITE:
                color = self.get_color(point)
                ...
                while index != BORDER:
                    index += 1
                    if index < self.maxpoint:
                        if self.get_color(index) == color:
                            counter += 1
                        else:
                            break

                # Check if there is a row winner and return the winner
                if counter >= 5:
                    return color
